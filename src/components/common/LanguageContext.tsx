...
const MASTER_DICTIONARY: Record<string, string> = {
  ...
  'Concluded events and photographs will be published here soon.': 'संपन्न कार्यक्रमों के छायाचित्र यहां शीघ्र प्रकाशित किए जाएंगे।',
  ...
  'All submissions are delivered directly to the Chamber administrative office.': 'सभी संदेश सीधे चैम्बर कार्यालय को प्रेषित किए जाते हैं।',
  'Message Received': 'संदेश प्राप्त हुआ',
  'Thank you! Our team will review your message and get in touch with you shortly.': 'धन्यवाद! हमारी टीम आपके संदेश की समीक्षा कर शीघ्र संपर्क करेगी।',
  ...
  'Your enterprise listing has been received. After verification, your profile will be activated on the portal.': 'आपका आवेदन प्राप्त हो गया है। सत्यापन के पश्चात आपका प्रतिष्ठान पोर्टल पर सक्रिय हो जाएगा।',
  ...
  // Login & Admin
  'Chamber Administrative Login': 'प्रशासनिक लॉगिन',
  ...
  'Email Address': 'ईमेल पता',
  'Password': 'पासवर्ड',
  'Sign In to Admin Panel': 'एडमिन पैनल में साइन इन करें',
...
const WORD_DICTIONARY: Record<string, string> = {
  ...
  'job': 'नौकरी',
  'committee': 'समिति',
  'chamber office': 'चैम्बर कार्यालय',
  'membership': 'सदस्यता',
  'contact': 'संपर्क',
  'search': 'खोजें',
  'filter': 'फिल्टर',
